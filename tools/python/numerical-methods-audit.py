...
class NumericalMethodsAuditor:
    ...
    def analyze_code_quality(self, content, file_path):
        ...
        if '${USER_HOME:-/Users/daniellynch}' in content:
...
def main():
    ...
    auditor.audit_directory('${DEVELOPER_DIR:-${USER_HOME:-/Users/daniellynch}/Developer}')
    ...
    with open('${DEVELOPER_DIR:-${USER_HOME:-/Users/daniellynch}/Developer}/numerical-audit-results.json', 'w') as f:
